...
const OrderPocessing = () => {
  return (
    <section className=" mx-2 mt-10 bg-white p-5 rounded">
      <h2 className=" mb-5 font-semibold"> Order Processing 55434</h2>
      <table className=" w-full ">
        <thead className=" p-2   border-b-[1px] border-[#d4d4d4]">
          <tr className=" ">
            <th className=" w-1/12 text-left py-2 font-semibold capitalize text-[#1a1a1a]">
              Order Id
            </th>
        ...
        <tbody className="text-[#737c83]">
          <tr className=" border-b-[1px] border-[#d4d4d4] ">
            ...
            <td className=" text-left font-bold py-5 ">
              <p className=" capitalize text-[#dbc536]">Shipped</p>
            </td>
            <td className=" text-left font-bold py-5">
              <button className=" btn btn-xs bg-[#3ecbac] border-none">
                Delivered
              </button>
            </td>
          </tr>
